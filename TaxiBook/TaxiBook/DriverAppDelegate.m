...
//    }
//    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"TaxiBook" withExtension:@"momd"];
...
//    }
//    
//    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"TaxiBook.sqlite"];
//    
//    NSError *error = nil;
